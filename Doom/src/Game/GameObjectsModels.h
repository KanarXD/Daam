...
const static std::unordered_map<std::string, ModelSpec> GOModels{
	{ "default", {
		...
		{  },
		"res/models/Default/default.obj" , "shaderCTL" } },
	
	{ "player",	{
		{ glm::vec3(0, 2, 0), glm::vec3(1, 2, 1) },
		{ "box", "bullet", "enemy_bullet", "healthkit", "enemy" , "enemy_fast", "enemy_tank", "enemy_boss" },
		"", "" } },
	
	{ "enemy", {
		{ glm::vec3(0, 0, 0), glm::vec3(1.5f) },
		{ "box", "bullet", "player_bullet", "player", "enemy" , "enemy_fast", "enemy_tank", "enemy_boss" },
	...
	{ "box", { 
		...
		{ "player", "bullet", "enemy_bullet", "player_bullet", "enemy" , "enemy_fast", "enemy_tank", "enemy_boss" },
		"", "" } }
};
